        ...
        <main class="container">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                    <%-- buttons go here --%>
                    <asp:Button ID="Btn_sendQuotation" runat="server" Text="Please Send the Quotation" 
                        CssClass="btn btn-primary" OnClick="Btn_sendQuotation_Click"/>
                    <asp:Button ID="Btn_return" runat="server" Text="Back" CssClass="btn btn-primary" PostBackUrl="~/Default.aspx" />
            ...
            <div class="form-group">
                <div class="col-sm-offset-1 col-sm-11">
                    ...
                    <asp:Label ID="Lbl_send" runat="server" Text="please send ." Font-Size="medium" Forecolor="Black"></asp:Label> 
                </div>
            </div>
